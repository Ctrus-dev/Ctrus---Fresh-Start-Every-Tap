...
struct HomeView: View {
  ...
  // Hides the Activity habit tracker on the home page without removing it from the codebase.
  private let showActivityTracker = false
