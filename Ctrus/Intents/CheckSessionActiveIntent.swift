...
struct CheckSessionActiveIntent: AppIntent {
  ...
  static var title: LocalizedStringResource = "Check if Ctrus Session is Active"
  static var description = IntentDescription(
    "Check if any Ctrus blocking session is currently active and return true or false. Useful for automation and shortcuts."
  )
