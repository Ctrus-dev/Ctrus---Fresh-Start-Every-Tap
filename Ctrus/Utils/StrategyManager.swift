...
class StrategyManager: ObservableObject {
  ...
  // Full set of strategies the app knows how to run, including ones no longer
  // offered in the picker but still needed to resolve existing profiles and
  // internal flows (Emergency Unblock, deep link/background stop, Shortcuts).
  ...
  static let pickerStrategies: [BlockingStrategy] = [
    NFCBlockingStrategy(),
    NFCManualBlockingStrategy(),
  ]
